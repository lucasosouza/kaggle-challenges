...
def get_added_products(preds, X_test, labels, current_products):
    ...
    current_products['products'] = current_products.apply(consolidate_products, axis=1)
    print("current_products: ", current_products.shape)
    ...
    diff['products'] = current_products['products']
